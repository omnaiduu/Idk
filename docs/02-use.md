...
| MCP drawer | Last MCP tool + PASS / RAN / FAIL (not a chat) |
...
**RAN** means your firmware halted and the sim finished, but it did not match that demo checklist — this is the normal result for **custom code**. UART, LEDs, servos, and the screen still show what *your* program did. It is not a crash.
